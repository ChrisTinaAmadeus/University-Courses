...
求该磁盘的容量（GB 为单位）。
磁盘容量=2×2×500000×500×4096/10^9=4096GB


**1.2.1**

求该磁盘访问⼀个扇区的平均延迟（ms 为单位）。
平均延迟=10+1/2×1/5400×60×1000+1/5400×1/500×60×1000=15.6ms
...
文件应存储在同一柱面的所有面上，然后再移动到相邻柱面。
500×4096Byte×4/10^6=8.192MB
使寻道时间不改变（只寻道一次）
寻道时间：10
旋转延迟：1/2×1/5400×60×1000
传送时间：1/5400×60×1000
总访问延迟：寻道+4×旋转+4×传送=76.7ms
因此带宽=8.192/76.7=106.9MB/s


## 截止日期：本作业截止9月21日23.55